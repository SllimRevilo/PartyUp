...
@Component({
  ...
  styleUrls: ['./community-calendar.page.scss'],
})
export class CommunityCalendarPage implements OnInit {
  ...
  constructor(private alertCtrl: AlertController, @Inject(LOCALE_ID) private locale: string,private afs: AngularFirestore,public fbService: FirebaseService,private router:Router,private route:ActivatedRoute,) { }
  ...
  ngOnInit() {
    ...
    this.communityCollection = this.afs.collection<Community>('communities', ref => ref.where('cid', '==', this.community.cid));
